...
alignas(kPageSize4K) std::array<uint64_t, 512> plm4_table;
...
void SetupIdentityPageTable() {
    plm4_table[0] = reinterpret_cast<uint64_t>(&pdp_table[0]) | 0x003;
    ...
    SetCR3(reinterpret_cast<uint64_t>(&plm4_table[0]));
}